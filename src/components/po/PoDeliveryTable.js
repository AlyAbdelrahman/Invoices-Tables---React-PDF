    ...
    return (
        <View>
            <View style={styles.deliveryTableContainer}>
                ...
                <View style={[styles.deliveryTerms, styles.tableCell, styles.headerCell]}>
                    <Text style={[styles.cellText, styles.cellHeaderText]}>
                        DELIVERY TERMS
                    </Text>
                </View>
                <View style={[styles.paymentTerms, styles.tableCell, styles.headerCell]}>
                    <Text style={[styles.cellText, styles.cellHeaderText]}>
                        PAYMENT TERMS
                    </Text>
                </View>
                <View style={[styles.partialShipments, styles.tableCell, styles.headerCell]}>
                    <Text style={[styles.cellText, styles.cellHeaderText]}>
                       PARTIAL SHIPMENTS
                    </Text>
                </View>
            ...
            <View style={styles.deliveryTableContainer}>
                ...
                <View style={[styles.paymentTerms, styles.tableCell]}>
                    <Text style={[styles.cellText, styles.cellHeaderText]}>
                        100 % within two weeks from date of reveving matrials and orginal invoice
                    </Text>
                </View> 
