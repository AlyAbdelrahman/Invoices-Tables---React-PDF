            ...
            <View style={styles.detailsContainer}>
                <View style={styles.poHeaderInfoContainer}>
                    <View style={styles.SingleValuesContianer}>
                        <Text style={[styles.infoText, styles.infoKeyText]}>Vendor Name</Text>
                    ...
                    <View style={styles.SingleValuesContianer}>
                        ...
                        <Text style={[styles.infoText, styles.infoKeyText]}> : </Text>
                        <Text style={styles.infoText}>28 omer ebn elkhattab st., Dokki</Text>
                    </View>
                    <View style={styles.SingleValuesContianer}>
                ...
                <View style={styles.shipingInfoContainer}>
                    <View style={styles.poShippingContainer}>
                        ...
                        <View style={styles.SingleValuesContianer}>
                            <Text style={[styles.infoText, styles.infoKeyText]}>Ship To / Bill To</Text>
                            <Text style={[styles.infoText, styles.infoKeyText]}> : </Text>
                            <Text style={styles.infoText}>General Petroleum Company C/O Scimitar Production Egypt LTD. (SPEL)</Text>
                        </View>
                        <View style={styles.SingleValuesContianer}>
                            <Text style={[styles.infoText, styles.infoKeyText]}>Address</Text>
                            <Text style={[styles.infoText, styles.infoKeyText]}> : </Text>
                            <Text style={styles.infoText}>Block-E, plot # 5, 1st Settlement Service Center, New CAiro 114477, Cairo, Egypt</Text>
                        </View>
                        <View style={styles.SingleValuesContianer}>
                            <Text style={[styles.infoText, styles.infoKeyText]}>Phone</Text>
                            <Text style={[styles.infoText, styles.infoKeyText]}> : </Text>
                        ...
                        <View style={styles.SingleValuesContianer}>
                            <Text style={[styles.infoText, styles.infoKeyText]}>Attention</Text>
                            <Text style={[styles.infoText, styles.infoKeyText]}> : </Text>
                            <Text style={styles.infoText}>Procurement & Logistics Manger</Text>
                        </View>
                        <View style={styles.SingleValuesContianer}>
                            <Text style={[styles.infoText, styles.infoKeyText]}>Email</Text>
                            <Text style={[styles.infoText, styles.infoKeyText]}> : </Text>
