    ...
    return (
        <View style={styles.poDescriptionTableContainer}>
            <View style={styles.deliveryTableContainer} fixed>
                ...
                <View style={[styles.descriptionCell, styles.tableCell, styles.headerCell]}>
                    <Text style={[styles.cellText, styles.cellHeaderText]}>
                        DESCRIPTION
                    </Text>
                </View>
                ...
                <View style={[styles.quantityCell, styles.tableCell, styles.headerCell]}>
                    <Text style={[styles.cellText, styles.cellHeaderText]}>
                        QYT
                    </Text>
                </View>
                <View style={[styles.amountCell, styles.tableCell, styles.headerCell, styles.customPadding]}>
                    <Text style={[styles.cellText, styles.cellHeaderText]}>
                        QYT
                    </Text>
            ...
            {Array(30).fill(1).map((el, index) => (<View style={styles.deliveryTableContainer}>
                ...
                <View style={[styles.amountCell, styles.tableCell, styles.customPadding, styles.amountCellDetailsContainer]}>
